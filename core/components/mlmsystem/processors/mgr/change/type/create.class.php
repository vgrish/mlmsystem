...
/**
 * Create an MlmSystemTypeChanges
 */
class modMlmSystemTypeChangesCreateProcessor extends modObjectCreateProcessor {
...
return 'modMlmSystemTypeChangesCreateProcessor';