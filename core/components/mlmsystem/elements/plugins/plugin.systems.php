...
$modx->loadClass('MlmSystemPlugin', $MlmSystem->getOption('modelPath') . 'mlmsystem/systems/', true, true);
$modx->loadClass($className, $MlmSystem->getOption('modelPath') . 'mlmsystem/systems/', true, true);
